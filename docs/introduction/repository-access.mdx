...
> This information relates to the _hosted_ version, which is [violinist.io](https://violinist.io) - a SaaS providing automated update checks for Composer / PHP. If you are looking for access information about the on-prem / self hosted version of [update-check-runner](https://github.com/violinist-dev/update-check-runner/) please visit [Repository access for on-prem / self hosted violinist update check runners](/introduction/repository-access-self-hosted)
